...
- **Metas da estação**: cada meta diz **para quem** é (a colmeia inteira, uma pessoa ou um grupo de pessoas: só os pontos de quem está nela contam) e **quando** vale (a estação inteira ou um pedaço dela, com começo e fim dentro da estação). A meta da colmeia que corre hoje abre a tela inicial, com o favo enchendo e o ranking de quem mais ajudou.
- **Roteiro da estação**: a estação desenhada de ponta a ponta, com o dia de hoje marcado e uma faixa por meta, colorida pelo que está por vir, em andamento, batida ou perdida. Fica na tela inicial, na tela Metas e dentro de cada estação.
- **Tela Metas**: em `/metas`, o roteiro no alto e depois as metas separadas em "Da colmeia inteira" e "De pessoas e grupos", com filtro por situação (todas, ativas, futuras, batidas, perdidas) e as encerradas dobradas no fim.
