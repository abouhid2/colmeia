...
export function buildDemoState(now: Date = new Date()): LocalState {
  ...
  const completions = [
    ...
    completion({ id: 67, taskId: null, memberId: 4, taskTitle: "Regar as plantas", taskPoints: 5, completedAt: lastWeek(2) }),
    completion({ id: 68, taskId: null, memberId: 4, taskTitle: "Lavar a louça do jantar", taskPoints: 5, completedAt: lastWeek(5) }),
    completion({ id: 69, taskId: null, memberId: 4, taskTitle: "Aspirar a sala e os quartos", taskPoints: 20, completedAt: lastWeek(6) }),
  ];
